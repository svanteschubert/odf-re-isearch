...
interface Constants {
  ...
  public static final String ODFTK_DEFAULT_LIST = "OTK_DEFAULT_LIST";
  public static final String ODFTK_DEFAULT_STYLE_PREFIX = "default_";
  public static final String ODFTK_DEFAULT_STYLE_SUFFIX = "_style";
